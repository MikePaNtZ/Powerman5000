...
void APowerman5000Character::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
	...
	InputComponent->BindAxis("TurnRate", this, &APowerman5000Character::TurnAtRate);
	InputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	InputComponent->BindAxis("LookUpRate", this, &APowerman5000Character::LookUpAtRate);

	// handle touch devices
	InputComponent->BindTouch(IE_Pressed, this, &APowerman5000Character::TouchStarted);
	InputComponent->BindTouch(IE_Released, this, &APowerman5000Character::TouchStopped);
}


void APowerman5000Character::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
...
void APowerman5000Character::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
	if (FingerIndex == ETouchIndex::Touch1)
	{
		StopJumping();
...
void APowerman5000Character::TurnAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerYawInput(Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}

void APowerman5000Character::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

void APowerman5000Character::MoveForward(float Value)
{
...
void APowerman5000Character::MoveRight(float Value)
{
	if ( (Controller != NULL) && (Value != 0.0f) )
	{
